  ...
  <fieldset class="mt-10 pt-10 border-t border-black">
    ...
    <div class="grid grid-cols-6 gap-6">
      <div class="col-span-6 sm:col-span-3">
        <!-- Lightfast Rating -->
        <div class="mt-6">
          <label for="granulationRatingId" class="block text-sm text-gray-500">Lightfastness</label>
        ...
        <!-- Transparency Rating -->
        <div class="mt-6">
          <label for="transparencyRatingId" class="block text-sm text-gray-500">Transparency</label>
        ...
        <!-- Staining Rating -->
        <div class="mt-6">
          <label for="stainingRatingId" class="block text-sm text-gray-500">Staining</label>
        ...
        <!-- Granulation Rating -->
        <div class="mt-6">
          <label for="granulationRatingId" class="block text-sm text-gray-500">Granulation</label>
