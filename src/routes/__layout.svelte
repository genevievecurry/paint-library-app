    ...
    <header class="relative border-b-2 border-black">
      <div class="py-6">
        <nav
          ...
          <div class="relative flex items-center justify-between md:w-full">
            <div
              class="hidden flex-1 md:flex md:items-center md:space-x-6 px-6">
    ...
    <footer aria-labelledby="footerHeading">
      ...
      <div
        ...
        <div class="mt-12 border-t border-gray-200 py-8">
          <div
            class="flex w-full text-base text-gray-500 text-center font-light mx-auto justify-center"
            ...
            <p>
              ...
              <a
                ...
                class="decorate-link inline-block">CC BY-SA 4.0</a>
            </p>
